---
title: Scout Rendering Test
description: This test page shows all mascot images as well as the admonition styles for our pedagogical agent Scout
...
!!! mascot-neutral "A Note from Scout"
    ![Scout notes](../img/mascot/neutral.png){ class="mascot-admonition-img" }
    Here is a friendly note from Scout.

!!! mascot-welcome "Scout Welcomes You!"
    ![Scout welcomes you](../img/mascot/welcome.png){ class="mascot-admonition-img" }
    Welcome, friend! Healthy choices, happy you!

!!! mascot-thinking "Scout Key Insight"
    ![Scout is thinking](../img/mascot/thinking.png){ class="mascot-admonition-img" }
    Let's think this through together!

!!! mascot-tip "Scout's Tip"
    ![Scout shares a tip](../img/mascot/tip.png){ class="mascot-admonition-img" }
    Here is a helpful suggestion.

!!! mascot-warning "Scout Gentle Warning of Common Mistake"
    ![Scout warns you](../img/mascot/warning.png){ class="mascot-admonition-img" }
    Watch out for this one!  It can be tricky!

!!! mascot-encourage "You've Got This!"
    ![Scout encourages you](../img/mascot/encouraging.png){ class="mascot-admonition-img" }
    You can do it!  I have faith in you!

!!! mascot-celebration "Excellent Work!"
    ![Scout celebrates](../img/mascot/celebration.png){ class="mascot-admonition-img" }
