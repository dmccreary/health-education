---
title: Learning Graph — Grade 1
description: Introduction to the Grade 1 band learning graph.
---

# Learning Graph — Grade 1

This section contains the learning graph for the Grade 1 band of the
...
concepts rather than 200 — because Grade 1 health benchmarks are
identify-and-explain-level content for 6-7 year olds (see the
