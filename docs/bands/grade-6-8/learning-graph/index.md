---
title: Learning Graph — Grade 6-8
description: Introduction to the Grade 6-8 band learning graph.
---

# Learning Graph — Grade 6-8

This section contains the learning graph for the Grade 6-8 band of the
...
This band's graph is substantially larger than the K-5 bands' graphs — 133
concepts, roughly double Grade 5's 70 — because Grade 6-8 is the first band
graded as a 3-grade span rather than a single grade, and the first band
where Sexual Health (added to Human Growth and Development) and Substance
Use Awareness and Prevention (an entirely new strand) appear (see the
[Course Description Assessment](./course-description-assessment.md) for the
rationale). It builds directly on the Kindergarten through Grade 5 bands'
graphs for the five strands they share, and introduces genuinely new content
...
- Longest dependency chains (maximum length: 8)
...
into a single primary classifier. This band uses 8 categories — the 7
categories carried forward from Kindergarten through Grade 5, plus a new
Substance Use Awareness and Prevention (SUB) category for this band's new
strand.

- A concept classifier taxonomy with 8 categories
- Category organization - foundational elements first
- Balanced categories (0.8% - 22.6% each)
