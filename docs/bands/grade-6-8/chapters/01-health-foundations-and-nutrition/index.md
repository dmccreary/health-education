---
title: Health Foundations and Nutrition
description: Grade 6-8 opening chapter defining health as a whole-person idea and launching the Food and Nutrition strand, covering dietary guidelines across cultures, food label and marketing claims analysis, water versus sugary and caffeinated drinks, effects of sugary and salty foods, meal and snack planning, and food sovereignty and community food access.
generated_by: claude skill chapter-content-generator
date: 2026-07-06 17:01:47
version: 0.09
---
...
1. Health
2. Dietary Guidelines Across Cultures
3. Food Label Analysis
4. Marketing Claims Analysis
5. Water Versus Sugary Drinks
6. Caffeinated And Energy Drink Effects
7. Effects Of Sugary And Salty Foods
...
This is the first chapter in the Grade 6-8 band. It assumes only the bridging concepts described in the [course description](../../course-description.md), carried forward from the Grade 5 band.

---

!!! mascot-welcome "Hey there, I'm Scout."
    ...
    1. **Welcome** — I open every chapter this way.
    2. **Think** — I flag an idea worth pausing on and reasoning through.
    3. **Tip** — I hand you a practical strategy you can actually use.
    4. **Warn** — I flag a place where people get misled or make a common mistake.
    5. **Encourage** — I back you up when the material gets genuinely hard.
    6. **Celebrate** — I mark the moments where you've earned it.
...
1. **"All natural"** — This phrase has no strict legal definition for most foods in the United States and is only loosely and inconsistently enforced. A product can be "all natural" and still be high in sugar, sodium, or refined ingredients — natural does not mean healthy.
2. **"No added sugar"** — This claim is meaningful and regulated: it means no sugars were added during processing. However, it does not mean sugar-free — a "no added sugar" fruit juice can still be high in naturally occurring sugar.
3. **"Made with real fruit"** — This can legally apply even when the actual fruit content is extremely small, such as a fruit-flavored snack that contains a small amount of fruit puree or concentrate alongside much larger amounts of sugar and food coloring.
4. **"Lightly sweetened" / "Reduced sugar"** — These are relative claims, meaning the product has less sugar than a reference version of the same product — not that the product is low in sugar overall.
...
Type: chart
**sim-id:** sugar-content-blood-sugar-comparison<br/>
**Library:** Chart.js<br/>
**Status:** Specified
...
!!! mascot-encourage "This Can Feel Like a Lot"
...
1. **Energy needs** — matching portion and calorie content to activity level; a day with sports practice calls for more fuel than a low-activity day.
2. **Nutrient variety** — combining a source of protein, a whole grain or complex carbohydrate, and a fruit or vegetable tends to provide more sustained energy and broader nutrition than any single food group alone.
3. **Added sugar and sodium awareness** — using label-reading skills from earlier in this chapter to notice when a planned snack is unexpectedly high in either.
4. **Practicality and enjoyment** — a technically "perfect" meal plan that a student won't actually eat is not a useful plan; realistic planning accounts for taste, cost, and available time.
...
<iframe src="../../../../sims/build-a-meal-nutrition-planner/main.html" width="100%" height="500px" scrolling="no"></iframe>
<details markdown="1">
<summary>Build-A-Meal Nutrition Planner MicroSim</summary>
Type: microsim
**sim-id:** build-a-meal-nutrition-planner<br/>
**Library:** p5.js<br/>
**Status:** Specified
...
<iframe src="../../../../sims/indigenous-food-sovereignty-milestones/main.html" width="100%" height="500px" scrolling="no"></iframe>
<details markdown="1">
<summary>Indigenous Food Sovereignty Milestones Timeline</summary>
Type: timeline
**sim-id:** indigenous-food-sovereignty-milestones<br/>
**Library:** vis-timeline<br/>
**Status:** Specified

Bloom Taxonomy: Understand (L2)
Bloom Taxonomy Verb: describe, summarize, explain
