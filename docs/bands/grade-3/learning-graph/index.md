---
title: Learning Graph — Grade 3
description: Introduction to the Grade 3 band learning graph.
---

# Learning Graph — Grade 3

This section contains the learning graph for the Grade 3 band of the
...
This band's graph is intentionally smaller than a general-purpose graph — 57
concepts rather than 200 — because Grade 3 health benchmarks are
describe/explain-level content, with the first genuine evaluate-level
reasoning and the first explicit puberty topic, for 8-9 year olds (see the
[Course Description Assessment](./course-description-assessment.md) for the
rationale). It builds directly on the Kindergarten (45-concept), Grade 1
(55-concept), and Grade 2 (55-concept) bands' graphs and uses the same
7-category taxonomy for cross-band comparability.
...
its connections. The viewer opens with the Grade 3 graph loaded; you can
switch to any other grade band from the dropdown.

[Open the Grade 3 Learning Graph Viewer](../../../sims/graph-viewer/main.html?band=grade-3){ .md-button .md-button--primary }

<iframe src="../../../sims/graph-viewer/main.html?band=grade-3" width="100%" height="600px" frameborder="0"></iframe>
