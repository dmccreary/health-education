---
title: Learning Graph — Grade 4
description: Introduction to the Grade 4 band learning graph.
---

# Learning Graph — Grade 4

This section contains the learning graph for the Grade 4 band of the
...
This band's graph is intentionally smaller than a general-purpose graph — 58
concepts rather than 200 — because Grade 4 health benchmarks are
plan/explain/analyze-level content, with the first genuine create-level
reasoning (meal planning, goal-plan development, research-based positions)
and the start of required mental-health instruction, for 9-10 year olds (see
the [Course Description Assessment](./course-description-assessment.md) for
the rationale). It builds directly on the Kindergarten (45-concept), Grade 1
(55-concept), Grade 2 (55-concept), and Grade 3 (57-concept) bands' graphs
...
its connections. The viewer opens with the Grade 4 graph loaded; you can
switch to any other grade band from the dropdown.

[Open the Grade 4 Learning Graph Viewer](../../../sims/graph-viewer/main.html?band=grade-4){ .md-button .md-button--primary }

<iframe src="../../../sims/graph-viewer/main.html?band=grade-4" width="100%" height="600px" frameborder="0"></iframe>
