---
title: Learning Graph — Grade 5
description: Introduction to the Grade 5 band learning graph.
---

# Learning Graph — Grade 5

This section contains the learning graph for the Grade 5 band of the
...
This band's graph is intentionally smaller than a general-purpose graph — 70
concepts rather than 200 — because Grade 5 health benchmarks, while the
richest and most granular of the K-5 bands (31 benchmark-coded topics), are
still scoped to upper-elementary compare/apply/evaluate-level content for
10-11 year olds (see the [Course Description Assessment](./course-description-assessment.md)
for the rationale). Grade 5 is the last individually-graded band before the
2025 Minnesota K-12 Health Academic Standards shift to grade spans (6-8,
9-12). It builds directly on the Kindergarten (45-concept), Grade 1
(55-concept), Grade 2 (55-concept), Grade 3 (57-concept), and Grade 4
