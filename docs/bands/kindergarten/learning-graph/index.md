---
title: Learning Graph — Kindergarten
description: Introduction to the Kindergarten band learning graph.
---

# Learning Graph — Kindergarten

This section contains the learning graph for the Kindergarten band of the
...
This band's graph is intentionally smaller than other bands' — 45 concepts
rather than a general-purpose 200 — because Kindergarten health benchmarks
are narrow, identify/name-level content for 5-6 year olds (see the
...
its five content strands plus a cross-cutting Skill Standards group.

- A concept classifier taxonomy with 7 categories
- Category organization - foundational elements first
- Balanced categories (2.2% - 22.2% each)
