---
title: Warning Sign Recognition Guide
description: Students identify and recognize the categories of verbal, behavioral, and emotional warning signs associated with suicide or self-harm risk, so they can name what they are noticing in a caring, non-diagnostic way.
status: scaffold
library: p5.js
bloom_level: Remember (L1)
---

# Warning Sign Recognition Guide
