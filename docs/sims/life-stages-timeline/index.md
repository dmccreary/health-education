...
description: Students explain that puberty is one normal life stage among several across a human lifespan, and describe its general place and range in that sequence.
status: scaffold
